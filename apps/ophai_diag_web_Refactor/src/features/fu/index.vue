...
<script lang="ts" setup>
  ...
  import loading from '@/shared/components/common/Loading/Loading.vue'
  ...
  const FuUpload = defineAsyncComponent({
    loader: () => import('@/features/fu/components/FuUpload/FuUpload.vue'),
